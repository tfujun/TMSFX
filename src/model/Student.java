...
public class Student {
    ...
    public void updateDetails(String name, String email, String phone, String address, String type, String ID, int credits, double scholarship, String deductionCode){       
        this.name.set(name);    
        this.email.set(email);        
        this.phone.set(phone);     
        this.address.set(address);        
